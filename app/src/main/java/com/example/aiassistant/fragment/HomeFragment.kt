...
class HomeFragment : Fragment() {
    ...
    private lateinit var tvShizhengStats: TextView
    private lateinit var btnShizheng: View
    private lateinit var btnTimerHistory: View
    ...
    private fun bindViews(view: View) {
        ...
        btnActionRecord = view.findViewById(R.id.btn_action_record)
            ...
            tvShizhengStats = view.findViewById(R.id.tv_shizheng_stats)
            btnShizheng = view.findViewById(R.id.btn_shizheng)
            btnTimerHistory = view.findViewById(R.id.btn_timer_history)
    }
    ...
    private fun setupListeners() {
        ...
        btnShizheng.setOnClickListener {
            val intent = Intent(requireContext(), com.example.aiassistant.shizheng.ShizhengActivity::class.java)
            startActivity(intent)
        }

        btnTimerHistory.setOnClickListener {
            val intent = Intent(requireContext(), com.example.aiassistant.TimerHistoryActivity::class.java)
            startActivity(intent)
        }
