...
class ScreenCaptureService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        if (resultCode != Int.MIN_VALUE && data != null) {
            ...
            // 在本 App 界面内开启悬浮球时，立即收起，避免盖住自己的页面
            if (App.isAppUiVisible) hideBallForInApp()
            try {
     ...
     * @return true 恢复成功
     */
    internal fun tryAutoRecoverMediaProjection(): Boolean {
            ...
            mainHandler.post {
                ...
                captureHandler?.post {
                    ...
                    if (ocrMode == AppPreferences.OCR_MODE_CLOUD) {
                        ...
                        val cleanedOcrText = mergeWrappedLines(
                            ocrText.lines()
                                .map { it.trim() }
